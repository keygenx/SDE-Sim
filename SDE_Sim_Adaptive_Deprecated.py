...
cpu_buffer_size = 200 #memory buffer for VRAM->RAM (GPU->CPU) data transfer
num_par = 1_000_000 #number of parallel simulations
mem_height = 4 #size of datastructure in GPU. Minimum: 2. array size = mem_height x num_par
    ...
    while(t < t_end):
        ...
        if i%20 == 0 or t>=t_end:
               print("<"+"="*int(t*50/(t_end-t_init))+"_"*int(50*(1-t/(t_end-t_init)))+">"\
                     ...
                     + f" buffer: {cpu_buffer_size - q1.qsize()-2}", end='\r')
